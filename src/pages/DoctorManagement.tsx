...
import { Users, Plus, Edit, Trash2, Building2, Stethoscope } from 'lucide-react';
      ...
      <div className="px-4 py-6 sm:px-0">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="mt-2 text-gray-600">Manage healthcare professionals and their schedules</p>
          </div>
          <button
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2 text-gray-600">
                    ...
                    <span className="text-sm">{doctor.hospitals?.name}</span>
                  </div>
